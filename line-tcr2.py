...
kc = LINETCR.LINE()
kc.login(token='El7d3luRkoiqx0RXP8Md.9pUhX45E7oBPdnzBTNba3q.hGzG9Gy8Cm9MSDKl3oJkN9cq8rGihbzbniDEzWb5E+Q=')
kc.loginResult()

kd = LINETCR.LINE()
kd.login(token='Elr6gJxE4BdLiaNMN6Ra.AS+5ifZOG/3k0fdUVXmgMG.IV6kNr0rkCbaL8COFZjM78gNqLvMiAl/eHkKEOvqEf8=')
kd.loginResult()

ke = LINETCR.LINE()
ke.login(token='ElYNRWE7EUEXbMmZZ5H4.pALMRotCxh+7iMWfr8ZwXa.+1oiT7LaZ2ZAleFSrBeEVMrYMQYVtfHKxVozTlfDJcY=')
ke.loginResult()

kf = LINETCR.LINE()
kf.login(token='ElCUqWrGOfvh1hOseoo2.dB1nhcD3ADgTBIgR4y35mG.wKyA1UGnDva5AVp8NXJ/DWK5k1/u/vlMD3ARKFANVus=')
kf.loginResult()

kg = LINETCR.LINE()
kg.login(token='ElpY0XcecSAyjYDcJrvf.+MLeAIVRR0wOhcnNLWTJxW.2hDIcnqJDdiv+LcT3WffeGgZFkDXAQABcWjW2dxmfto=')
kg.loginResult()

kh = LINETCR.LINE()
kh.login(token='El9xA4B20AJDm2xpywg7.GpdPO8tN+95wO57D8+9qzW.hvTtHWw93yryAIU+SKpKRnZuPGwgoQLQ9xGtauulO1U=')
kh.loginResult()

kj = LINETCR.LINE()
kj.login(token='ElK5ZaGALlrw0EpzFVl0.7Oh3UWXgxuXv/C4d5+E+Ca.wC/2onLXKxZn7byIw7B2CJ8T/1I9/G8WVJCMMuWBIuw=')
kj.loginResult()

kl = LINETCR.LINE()
kl.login(token='El3GFBBJa7PDXje4PVA5.fBWkRKdzbPLEKfOvgsePrq.5SZoQDky8KdNZkteb0XqxsPx7MxRKeoyZ7+Y5l6Ww98=')
kl.loginResult()

km = LINETCR.LINE()
km .login(token='ElFCOJFpAk7pq8uTnz56.oEQKuJcxug8wLkmozWzXPG.Ik+IyrMsGGsOb7zcS8dWMJv3kXr1MUI9Md/M4zYho2o=')
km.loginResult()
...
#-----------------------------------------------
                  ...
                  G.preventJoinByTicket = True
                  kd.updateGroup(G)
                  Ticket = ky.reissueGroupTicket(msg.to)
...
#-----------------------------------------------
                ...
                if msg.toType == 2:
                    ...
                    try:
                        ...
                        pass
            elif msg.text in ["Sisca out beb"]:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
                        ki.leaveGroup(msg.to)
                ...
                if msg.toType == 2:
                    ...
                    try:
                        ...
                        pass
            elif msg.text in ["Natali out beb"]:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
                        ki.leaveGroup(msg.to)
...
#-----------------------------------------------
                ...
                if msg.toType == 2:
                    ...
                    kh.sendText(msg.to,"Sampe ketemu lagi ok")
                    targets = []
                    for g in gs.members:
...
#-----------------------------------------------
                ...
                ki.sendText(msg.to,"idline: aldinorenaldi 􀨁􀄻double thumbs up􏿿􀜁􀅔Har Har􏿿")
                kk.sendText(msg.to,"instagram.com/aldinorenaldi 􀨁􀄻double thumbs up􏿿􀜁􀅔Har Har􏿿")
                kc.sendText(msg.to,"twitter.com/aldinorenaldi16 􀨁􀄻double thumbs up􏿿􀜁􀅔Har Har􏿿")
#------------------------------------------------------------------
            elif "Bc " in msg.text:
...
#----------------------------------------------------------------------------------------------------------
                ...
                ginfo = cl.getGroup(msg.to)
                cl.sendText(msg.to,"Selamat Datang ea di Grup " + str(ginfo.name))
...
#----------------------------------------------------------------------------------------------------------
                ...
                kk.sendText(msg.to,"New member wajib pap kntl Har Har􏿿")
#-----------------------------------------------
...
#-----------------------------------------------
            elif msg.text in ["Respon","respon","Member absen"]:              
                ki.sendText(msg.to,"Sisca Hadir kak Dino")
                kk.sendText(msg.to,"Natalia Hadir kak Dino")                
                kc.sendText(msg.to,"Christy Hadir kak Dino")
                kd.sendText(msg.to,"Okta Hadir kak Dino")
                ke.sendText(msg.to,"Dudut Hadir kak dino")
                kf.sendText(msg.to,"Frieska Hadir kak Dino")
                kg.sendText(msg.to,"Shania Hadir kak Dino")
                kh.sendText(msg.to,"Anin Juga Hadir kak Dino🤗🤗")
                kj.sendText(msg.to,"Desy Juga Hadir Kak")
                kl.sendText(msg.to,"Ayana Hadir nih,Walau baru bangun✌😂")
                km.sendText(msg.to,"Feni Juga Hadir Kak,Semua lengkap🙆🙆")
#-----------------------------------------------
